...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  not_found: {
    ...
    body: 'Este link não corresponde a um convite válido. Confira a URL ou peça um novo para quem convidou você.',
  },
  used: {
    title: 'Convite já utilizado',
    body: 'Este convite já foi aceito. Se não foi você, peça ao administrador da conta um link novo.',
  },
  expired: {
    title: 'Convite expirado',
    body: 'Este convite expirou. Peça ao administrador da conta um novo — leva poucos segundos para gerar.',
  },
  server_error: {
...
export default function JoinPage() {
  ...
  const handleAccept = useCallback(async () => {
    ...
    try {
      ...
      toast.success('Boas-vindas ao time');
    ...
    return (
      <Card className="w-full max-w-md border-border bg-card">
        <CardContent className="flex flex-col items-center gap-3 py-12">
          ...
          <p className="text-sm text-muted-foreground">Verificando o convite…</p>
        </CardContent>
      </Card>
    );
  }
          ...
          <DialogContent className="bg-popover border-border sm:max-w-md">
            ...
            <div className="space-y-2 py-2 text-xs text-muted-foreground">
              <p>
                ...
                saia e cadastre-se novamente com outro endereço de e-mail. O link
                do convite continua válido enquanto não expirar.
              </p>
            </div>
