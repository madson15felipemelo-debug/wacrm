  ...
  return (
    <div>
      <SettingsPanelHead
        ...
        description="Trechos reutilizáveis — texto simples ou uma mensagem interativa salva — que os atendentes inserem direto no campo de mensagem."
        action={
      ...
      {loading ? (
        ...
        <p className="rounded-lg border border-dashed border-border py-10 text-center text-sm text-muted-foreground">
          Nenhuma resposta rápida ainda. Crie uma para reaproveitar nas conversas.
        </p>
      ) : (
